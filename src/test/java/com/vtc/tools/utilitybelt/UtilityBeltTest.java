...
public class UtilityBeltTest {
	...
	public void setUp() throws Exception {
		...
		testlist.add((Object) file1);
		testlist.add((Object) file2);
	...
	public void testRoundDouble() {
		...
		String newnum = UtilityBelt.roundDouble(num);
	...
	public void testCreateVariantPools() throws InvalidInputFileException, InvalidOperationException {
		...
		TreeMap<String, VariantPool> AllVPs = UtilityBelt.createVariantPools(testlist, true);
