...
public class UnionOperationTest {
	...
	public void testUnionOperation1() {
		String in1 = "target/test-classes/UnionTests/Test1/input1.vcf";
		String in2 = "target/test-classes/UnionTests/Test1/input2.vcf";
		String answer = "target/test-classes/UnionTests/Test1/Answer.vcf";
		String out = "target/test-classes/OUTPUT/union/u_test1_out.vcf";
	...
	private void test2files(String answer, String out) {
		...
		VariantPool key_pool = new VariantPool(new File(answer), "1", false);
		VariantPool test_pool = new VariantPool(new File(out), "2", false);
