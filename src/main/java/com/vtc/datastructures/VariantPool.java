...
public class VariantPool implements Pool{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VariantPool other = (VariantPool) obj;
		System.out.println("Lets take a look at our VP's");
		
		if (addChr != other.addChr)
			return false;
		if (contigs == null) {
...
//			return false;
//		if (hMapChrPos == null) {
//			if (other.hMapChrPos != null)
//				return false;
//		} else if (!hMapChrPos.equals(other.hMapChrPos))
//			return false;
		if (hasGenotypeData == null) {
			if (other.hasGenotypeData != null)
				return false;
		} else if (!hasGenotypeData.equals(other.hasGenotypeData))
			return false;
		if (header == null) {
...
//			return false;
		if (potentialMatchingIndelAlleles != other.potentialMatchingIndelAlleles)
			return false;
		if (potentialMatchingIndelRecords != other.potentialMatchingIndelRecords)
			return false;
		if (samples == null) {
			if (other.samples != null)
				return false;
		} else if (samples.getSamples().size() != other.getSamples().size())
			return false;
		if (tMap == null) {
			if (other.tMap != null)
				return false;
		} else if (!tMap.equals(other.tMap))
			return false;
		return true;
	}
